...
cli.processInput = function(str) {
  ...
  // Only process the input  if user actuaaly wrote something, else ignore
  if (str) {
    // Codify the unique strings that identify the questions asked
    var uniqueInputs = [
      "man",
      "help",
      "exit",
...
// Init Script
cli.init = function() {
  // Send the start message to the console in dark blue this time
  ...
  _interface.on("line", function(str) {
    ...
    // Re-initoalize the prompt afterwards
    _interface.prompt();
  });
